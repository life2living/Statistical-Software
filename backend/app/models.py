...
AnalysisMethod = Literal["descriptive", "distribution", "fit_y_by_x", "oneway_anova", "multivariate", "correlation", "spc", "control_chart", "process_capability", "tabulate", "pareto", "gauge_rr", "variability_chart"]
